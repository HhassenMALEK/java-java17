...
public class Lambda_01_Test {
    ...
    public void test_filter_by_age() throws Exception {
       ...
       //PersonPredicate agePredicate= person ->person.getAge() > 17;
        //List<Person> result = filter(personList,agePredicate);
    ...
    public void test_filter_by_firstname() throws Exception {
        ...
        //PersonPredicate firstnamePredicate = person ->person.getFirstname().equals("first_10");
        //List<Person> result = filter(personList, firstnamePredicate);
    ...
    public void test_filter_by_password() throws Exception {
        ...
        PersonPredicate passwordPerdicate  = new PersonPredicate() {
            @Override
        ...
        List<Person> result = filter(personList, passwordPerdicate);
        /*PersonPredicate passwordPerdicate =person -> person.getAge() > 49 &&
        DigestUtils.sha512Hex( person.getPassword()).equals(passwordSha512Hex);
        List<Person> result = filter(personList, passwordPerdicate);*/
